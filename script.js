...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio | Altaf Shaikh";
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Computer Engineer", "Full Stack Developer", "Web Developer", "Software Developer", "Icon Vice precident at MMIT 2022-23", "Technical coordinator"],
        loop: true,
        typeSpeed: 50,
		backSpeed: 25,
		backDelay: 500,
...
/* SCROLL ABOUT */
srtop.reveal('.about .heading .row',{delay: 200});
...
/* SCROLL CONTACT */
srtop.reveal('.project .container',{delay: 400});
srtop.reveal('.project .container .form-group',{delay: 400});
